...
import { printHtml, PrintFormat } from '@/utils/print-quotation';
import {
  buildSaleOrderPrintHtml,
  SaleOrderPrintLabel,
} from '@/utils/print-sale-order';
...
export function SaleOrderPrintPreview({
  ...
  const html = useMemo(
    () => buildSaleOrderPrintHtml(detail, format, documentLabel),
    [detail, format, documentLabel],
  );
