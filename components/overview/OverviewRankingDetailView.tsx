...
export function OverviewRankingDetailView({
  ...
  const chartHint =
    kind === 'customers'
      ? showCompare
        ? `Top ${CUSTOMER_COMPARE_LIMIT} · ${selectedPeriodLabel} vs last month`
        : `Top ${CUSTOMER_CHART_LIMIT} · ${selectedPeriodLabel}`
      : stateFilterId == null
        ? showCompare
          ? `Top ${AREA_COMPARE_LIMIT} nationwide · ${selectedPeriodLabel} vs last month`
          : `Top ${AREA_NATIONWIDE_CHART_LIMIT} nationwide · ${selectedPeriodLabel}`
        : showCompare
          ...
          {loading ? (
            ...
            <View
              ...
              <VerticalBarChart
                ...
                currentLegend={selectedPeriodLabel}
                compareLegend={data?.compareLabel || 'Last month'}
                maxBars={kind === 'areas' && stateFilterId != null ? 50 : 15}
              />
